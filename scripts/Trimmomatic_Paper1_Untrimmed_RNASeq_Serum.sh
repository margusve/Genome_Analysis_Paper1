...
RNASeq1_BH_corrected_forward_paired.fq.gz RNASeq1_BH_corrected_forward_unpaired.fq.gz RNASeq1_BH_corrected_reverse_paired.fq.gz RNASeq1_BH_corrected_reverse_unpaired.fq.gz \
...
RNASeq2_BH_corrected_forward_paired.fq.gz RNASeq2_BH_corrected_forward_unpaired.fq.gz RNASeq2_BH_corrected_reverse_paired.fq.gz RNASeq2_BH_corrected_reverse_unpaired.fq.gz \
ILLUMINACLIP:TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36
...
RNASeq3_BH_corrected_forward_paired.fq.gz RNASeq3_BH_corrected_forward_unpaired.fq.gz RNASeq3_BH_corrected_reverse_paired.fq.gz RNASeq3_BH_corrected_reverse_unpaired.fq.gz \
ILLUMINACLIP:TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36
