...
bwa index -p enterococci_pacbio_index /home/margus/paper1_analysis_files/canu_genome_assembly_files/Canu_Assembly_Output_Pacbio/Enterococci.contigs.fasta
